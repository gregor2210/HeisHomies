...
func main() {
	...
	tcpReceiveChannel := make(chan masterSlave.WorldviewPackage)
	TCP_send_channel_listen := make(chan masterSlave.WorldviewPackage)
	TCP_send_channel_dail := make(chan masterSlave.WorldviewPackage)
